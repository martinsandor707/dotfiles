...
# Replace ls with eza
alias ls 'eza -algh --color=always --group-directories-first --icons' # preferred listing
alias lsz 'eza -algh --color=always --total-size --group-directories-first --icons' # include file size
...
alias lt 'eza -aTg --color=always --group-directories-first --icons' # tree listing
alias l. 'eza -aldg --color=always --group-directories-first --icons .*' # show only dotfiles
...
alias b="brave --enable-features=UseOzonePlatform --ozone-platform=wayland --disable-gpu --force-device-scale-factor=2  &>/dev/null & disown"
alias wb="waybar >/dev/null 2>/dev/null & disown"
alias st="GDK_DPI_SCALE=2 steam >/dev/null 2>/dev/null & disown"
